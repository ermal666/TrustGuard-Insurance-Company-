    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccidentInsurances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccidentInsurances_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccidentInsurances_Offers_OfferId",
                        column: x => x.OfferId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthInsurances_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TPLInsurances_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccidentInsurances_OfferId",
                table: "AccidentInsurances",
                column: "OfferId");

            migrationBuilder.CreateIndex(
                name: "IX_AccidentInsurances_UserId",
                table: "AccidentInsurances",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthInsurances_UserId1",
                table: "HealthInsurances",
                column: "UserId1");
